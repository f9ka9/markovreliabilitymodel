...
LineConnectionGraphics::LineConnectionGraphics(LineConnection* conn, NodeGraphics* first, NodeGraphics* second, const QList<QPointF>& points, QGraphicsItem* parent): QGraphicsObject(parent), connection(conn), firstNode(first), secondNode(second), bendPoints(points)
{
    setZValue(-0.5);
