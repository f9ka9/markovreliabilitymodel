...
private:
    ...
    static QPointF pointFromJson(const QJsonObject& object);
    ...
    static QString nodeKindToString(NodeKind kind);
    static bool nodeKindFromString(const QString& value, NodeKind& kind);
